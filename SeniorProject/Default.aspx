...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Submit" runat="server" Text="Submit" style="z-index: 1; left: 650px; top: 400px; position: absolute" OnClick="Submit_Click" OnClientClick="return confirm('Are you sure?')"/>
